...
# Example: Using your own voice sample
print("Generating Korean...")
text_ko = "안녕하세요! 채터박스 다국어 모델 테스트입니다."
wav_cloned = model.generate(text_ko, language_id="ko", audio_prompt_path="kr_woman_onelang_old_story_13s.wav")
ta.save("test-multi-ko-cloned.wav", wav_cloned, model.sr)
